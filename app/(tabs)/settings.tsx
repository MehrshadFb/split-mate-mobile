    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: colors.background.primary }}>
      <ScrollView className="flex-1">
        <View className="p-6">
          {/* Header */}
          <View className="mb-8">
            <Text style={{ fontSize: 36, fontWeight: 'bold', color: colors.text.primary, marginBottom: 8 }}>
              Settings
            </Text>
            ...
            <View style={{ backgroundColor: colors.background.secondary, borderRadius: 12, overflow: 'hidden' }}>
              ...
              >
                <View style={{ flexDirection: 'row', alignItems: 'center', flex: 1 }}>
                  <Ionicons name="sunny" size={24} color={colors.accent.primary} />
                  <View style={{ marginLeft: 12 }}>
                    <Text style={{ color: colors.text.primary, fontWeight: '500', fontSize: 16 }}>
                      Light
                    </Text>
                  </View>
                </View>
              ...
              >
                <View style={{ flexDirection: 'row', alignItems: 'center', flex: 1 }}>
                  <Ionicons name="phone-portrait" size={24} color={colors.accent.primary} />
                  <View style={{ marginLeft: 12 }}>
                    <Text style={{ color: colors.text.primary, fontWeight: '500', fontSize: 16 }}>
                      Automatic
                    </Text>
            ...
            <View style={{ backgroundColor: colors.background.secondary, borderRadius: 12, overflow: 'hidden' }}>
              <View style={{ 
                ...
                <View style={{ flexDirection: 'row', alignItems: 'center', flex: 1 }}>
                  ...
                  <Text style={{ color: colors.text.primary, fontWeight: '500', fontSize: 16, marginLeft: 12 }}>
                    Version
                  </Text>
                </View>
              ...
              <TouchableOpacity
                ...
                onPress={() => Linking.openURL('https://github.com/yourusername/splitmate')}
                activeOpacity={0.7}
              >
                <View style={{ flexDirection: 'row', alignItems: 'center', flex: 1 }}>
                  <Ionicons name="logo-github" size={24} color={colors.accent.primary} />
                  <Text style={{ color: colors.text.primary, fontWeight: '500', fontSize: 16, marginLeft: 12 }}>
                    Source Code
                  </Text>
                </View>
              ...
              <TouchableOpacity
                ...
                onPress={() => Linking.openURL('https://github.com/yourusername/splitmate/issues')}
                activeOpacity={0.7}
              >
                <View style={{ flexDirection: 'row', alignItems: 'center', flex: 1 }}>
                  <Ionicons name="bug" size={24} color={colors.accent.primary} />
                  <Text style={{ color: colors.text.primary, fontWeight: '500', fontSize: 16, marginLeft: 12 }}>
                    Report a Bug
                  </Text>
                </View>
          ...
          {/* App Info */}
          <View style={{ backgroundColor: colors.accent.light, borderRadius: 12, padding: 16, marginTop: 16 }}>
            <View style={{ flexDirection: 'row', alignItems: 'flex-start' }}>
              <Ionicons name="sparkles" size={20} color={colors.accent.primary} />
              <View style={{ flex: 1, marginLeft: 12 }}>
                <Text style={{ color: colors.accent.hover, fontWeight: '600', marginBottom: 4 }}>
                  About SplitMate
                </Text>
                <Text style={{ color: colors.text.secondary, fontSize: 14 }}>
                  ...
                  {"\n\n"}
                  Built with ❤️ using React Native and powered by Google Gemini AI.
                </Text>
              </View>
            </View>
          </View>
