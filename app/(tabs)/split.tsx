          ...
          <View className="mb-6">
            ...
            >
              ...
              <TouchableOpacity
                ...
                onPress={() =>
                  Linking.openURL("https://github.com/yourusername/splitmate")
                }
                activeOpacity={0.7}
              >
                <View
              ...
              <TouchableOpacity
                ...
                onPress={() =>
                  Linking.openURL(
                    "https://github.com/yourusername/splitmate/issues"
                  )
                }
                activeOpacity={0.7}
              >
            ...
            <View style={{ flexDirection: "row", alignItems: "flex-start" }}>
              ...
              <View style={{ flex: 1, marginLeft: 12 }}>
                ...
                <Text style={{ color: colors.text.secondary, fontSize: 14 }}>
                  ...
                  seconds.
                  {"\n\n"}
                  Built with ❤️ using React Native and powered by Google Gemini
                  AI.
                </Text>
              </View>
            </View>
